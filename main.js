...
const serverUrl = "https://2y68nyqgvddg.usemoralis.com:2053/server";
      const appId = "njkSQS4JLp8jWs82RbgJ39r6S09qeOmTxnkCJJUc";
...
getTransactions = async () => {
    ...
    const options = { chain: "rinkeby", address: "0x53c2C63771B74a9f1C63e4f003508C689E6e92Ff" };
...
millisecondsToTime = (ms) => {
    ...
    let days = Math.floor(ms / (1000 * 60 * 24));
